...
app.use(require('./src/routes/admin-proposals-donations')({ db, queries, adminAuth, logActivity, getSettings, maybeEngageReferral, addTreasuryEntry, merit }));
app.use(require('./src/routes/admin-wall')({ db, queries, adminAuth, logActivity }));
app.use(require('./src/routes/admin-merit')({ db, adminAuth, merit }));
