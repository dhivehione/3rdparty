...
app.use(require('./src/routes/legislation')({ db, lawsDb, queries, getSettings, maybeEngageReferral }));
app.use(require('./src/routes/treasury')({ db, queries, adminAuth, logActivity, addTreasuryEntry, getTreasuryBalance, getSettings }));
app.use(require('./src/routes/auth')({ db, queries, getSettings, logActivity, adminAuth, adminSessions, ADMIN_PASSWORD, sanitizeHTML, generateOTP, getReferralPoints, addTreasuryEntry, getTreasuryBalance }));
...
app.use(require('./src/routes/social')({ db, queries, getSettings, logActivity, adminAuth, userAuth, merit }));
